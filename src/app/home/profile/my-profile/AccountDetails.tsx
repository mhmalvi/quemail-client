...
const AccountDetails = () => {
  ...
  return (
    <div className="relative w-full h-full bg-background-color rounded-md xl:p-4 flex flex-col xl:gap-4 gap-0 overflow-hidden">
      ...
      <div className="flex flex-col w-full p-4 xl:gap-4 gap-2">
        <div className="flex flex-col">
          ...
          {editClicked ? (
            ...
            <h1 className="text-brand-color xl:px-4 px-2 xl:py-2 py-1 m-0">John</h1>
          )}
        </div>
        <div className="flex flex-col">
          ...
          {editClicked ? (
            ...
            <h1 className="text-brand-color xl:px-4 px-2 xl:py-2 py-1 m-0 ">Doe</h1>
          )}
        </div>
        <div className="flex flex-col">
          ...
          {editClicked ? (
            ...
            <h1 className="text-brand-color xl:px-4 px-2 xl:py-2 py-1 m-0">john@doe.com</h1>
          )}
        </div>
        <div className="flex flex-col">
          <label>Website</label>
          {editClicked ? (
            ...
            <h1 className="text-brand-color xl:px-4 px-2 xl:py-2 py-1 m-0">johndoe.com</h1>
          )}
        </div>
      </div>
      {editClicked && (
        <div className="px-4 flex items-center justify-end gap-4">
          <button className="px-4 py-2 bg-brand-color rounded-md">Save</button>
          <button
            onClick={() => {
