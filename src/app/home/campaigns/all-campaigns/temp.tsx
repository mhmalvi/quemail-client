          ...
          <div className="flex items-center justify-between gap-4 text-dark-black dark:text-slate-300 dark:border-slate-300 border-violet-50 ">
            <div className="flex items-center gap-4 xl:w-1/2 w-1/3">
              <button
                ...
                className="h-8 w-8 flex items-center justify-center rounded-md text-dark-black dark:bg-brand-color dark:text-slate-300 bg-violet-50 font-semibold border border-dark-black"
              >
                &lt;
              </button>
              ...
              <button className="w-1/8 h-full flex flex-col justify-center p-2 rounded-md xl:text-sm text-xs text-slate-300 border border-slate-300 hover:bg-brand-color bg-dark-black duration-100 ease-in-out">
                View Performance
              </button>
            </div>
          ...
          <div className="flex gap-4 h-full">
            <div className="flex flex-col items-center gap-4 w-1/2 h-5/6">
              <div className="rounded-md w-full overflow-hidden">
                <ListGroup className="relative rounded-none flex flex-col gap-0 w-full overflow-auto border-none">
                  <div className="sticky top-0 bg-violet-200 dark:bg-dark-black w-full flex items-center justify-center py-2 m-0">
                    <p className="w-full m-0 p-0 text-sm text-center text-dark-black dark:text-slate-300">
                      Recipient Table
                    </p>
                  </div>
                  <ListGroup.Item className="sticky top-0 bg-violet-200 dark:bg-dark-black hover:!bg-violet-200 w-full flex items-center justify-between p-0 m-0">
                    <p className="w-1/4 m-0 p-0 text-xs border-r border-dark-black dark:border-slate-300 text-dark-black dark:text-slate-300">
                      Name
                    </p>
                    <p className="w-1/4 m-0 p-0 text-xs border-r border-dark-black dark:border-slate-300 text-dark-black dark:text-slate-300">
                      Email
                    ...
                    <div className="w-1/4 flex items-center justify-center">
                      <Tooltip
                        ...
                        placement="bottom"
                      >
                        <p className="w-full m-0 p-0 text-xs text-dark-black dark:text-slate-300">
                          Status
                        </p>
                      </Tooltip>
                    </div>
            ...
            <div className="w-1/2 h-full overflow-auto">
              <div className=" h-full flex items-center justify-center bg-[#F7F8F9] shadow-md rounded-md p-2 overflow-auto">
                {showTemplateData === null ? (
                  <p className="flex items-center justify-center w-full h-full text-dark-black">
