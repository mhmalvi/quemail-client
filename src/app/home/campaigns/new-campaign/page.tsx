...
import { Dropdown, Modal, Table, Tabs } from "flowbite-react";
  ...
  return (
    <div className={COL_CONTAINER_STYLES}>
      <Tabs aria-label="Default tabs">
        <Tabs.Item title="1. Campaign Information" icon={HiUserCircle}>
          <CampaignInfo />
        </Tabs.Item>
        <Tabs.Item title="2. Add Template" icon={MdDashboard}>
          <ChooseTemplate />
        </Tabs.Item>
