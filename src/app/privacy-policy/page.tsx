...
const PrivacyPolicy = () => {
  return (
    <main className="flex min-h-screen flex-col items-center bg-background-color">
      <>
        <Navbar />
        <div className="w-full max-w-4xl p-6 bg-dark-glass shadow-lg rounded-lg mt-32">
          ...
          <ul className="list-disc list-inside text-slate-50 mb-4 space-y-2">
            <div>
            ...
            <div>
              ...
              in this Agreement) refers to Quadque Technologies Ltd, Level -7,
              8/C, F.R Tower, Panthapath, Dhaka 1207, Bangladesh.
            </div>
            ...
            <div>
              <strong>Website</strong> refers to Quemailer, accessible from{" "}
              <a
                href="https://www.quemailer.com"
                rel="external nofollow noopener"
                target="_blank"
                className="text-blue-500 underline"
              >
                https://www.quemailer.com
              </a>
            </div>
            <div>
          ...
          <ul className="list-disc list-inside text-slate-50 mb-4 space-y-2">
            <div>By email: dev.quadque@gmail.com</div>
          </ul>
        </div>
        <Footer />
      </>
