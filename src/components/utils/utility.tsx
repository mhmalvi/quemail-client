...
export const customTheme: CustomFlowbiteTheme = {
  modal: {
    ...
    header: {
      base: "flex items-center justify-between rounded-t-md xl:py-2 py-1 px-4 dark:bg-dark-glass bg-violet-200",
      title:
  ...
  pagination: {
    ...
    pages: {
      ...
      previous: {
        base: "ml-0 rounded-l-lg border border-gray-300 bg-white px-4 2xl:py-2 py-1  leading-tight text-gray-500 enabled:hover:bg-gray-100 enabled:hover:text-gray-700 dark:border-brand-color dark:bg-dark-black dark:text-gray-400 enabled:dark:hover:bg-gray-700 enabled:dark:hover:text-white",
        icon: "h-5 w-5",
      },
      next: {
        base: "rounded-r-lg border border-gray-300 bg-white px-4 2xl:py-2 py-1 leading-tight text-gray-500 enabled:hover:bg-gray-100 enabled:hover:text-gray-700 dark:border-brand-color dark:bg-dark-black dark:text-gray-400 enabled:dark:hover:bg-gray-700 enabled:dark:hover:text-white",
        icon: "h-5 w-5",
      },
      selector: {
        base: "w-12 border border-gray-300 bg-white px-4 2xl:py-2 py-1 leading-tight text-gray-500 enabled:hover:bg-gray-100 enabled:hover:text-gray-700 dark:border-brand-color dark:bg-dark-black dark:text-gray-400 enabled:dark:hover:bg-gray-700 enabled:dark:hover:text-white",
        active:
