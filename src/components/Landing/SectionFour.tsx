  ...
  return (
    <div className="w-full flex flex-col gap-4 items-center justify-center lg:h-screen h-full lg:py-0 py-16">
      ...
      <p className="p-0 m-0 lg:w-5/12 w-full text-center text-slate-300">
        Experience the Quemailer difference and take your email marketing to new
        heights. Sign up for our no-credit-card-required free trial and explore
        the full potential of Quemailer. With easy cancellation and
        comprehensive support, there’s no risk in discovering how Quemailer can
        revolutionize your marketing efforts.
      </p>
      <Image
        src={Images && Images.SectionFour}
        alt="HeroImage"
