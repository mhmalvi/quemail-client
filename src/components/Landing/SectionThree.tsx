...
const SectionTwo = () => {
  return (
    <div className="w-full flex flex-col gap-16 items-center justify-center h-full ">
      ...
      <div className="xl:w-full xl:p-0 lg:w-full lg:p-0 px-8 flex flex-wrap xl:gap-4 gap-y-4 justify-between">
        {sectionThreeData.map((items, index) => {
          return (
            <div
              key={index}
              className="flex flex-col xl:gap-2 items-center xl:w-1/5 lg:w-1/5 w-1/2 p-2"
            >
