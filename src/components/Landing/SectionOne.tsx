    ...
    <div className="w-full flex flex-col gap-4 items-center justify-center h-screen pt-20	">
      <h1 className="m-0 px-0 xl:text-4xl text-3xl text-center flex flex-col gap-2 text-slate-300 xl:mt-8 mt-16 w-1/2">
        ...
        <div className="w-full h-full flex flex-row justify-center items-center gap-4">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-brand-color to-brand-color-2 bg-[length:250%_250%] animate-gradient font-semibold xl:text-5xl text-4xl">
            Quemailer
          </span>
          <hr className="border w-full animate-glow"></hr>
        </div>
      ...
      <p className="p-0 m-0 xl:w-2/3 w-8/12 xl:text-base text-sm text-center text-slate-300">
        ...
        lasting connections with their audience through cutting-edge email
        marketing solutions. Our platform is meticulously designed to cater to
        the diverse needs of modern marketers, offering robust features and
        exceptional support to ensure your campaigns are both effective and
        impactful.
      </p>
      {/* <Image
      ...
      /> */}
      <iframe
        className="xl:w-1/2 h-1/2 lg:w-1/3 md:w-1/2"
        src="https://lottie.host/embed/24e27546-0c73-4ecb-824e-b9323f281f34/SlFkqQweFU.json"
      ></iframe>
      <button
        onClick={() => {
          handleTryFree();
